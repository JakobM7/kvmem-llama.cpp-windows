...
async function openWebUI(){let w=await q('/api/openwebui');if(!w.ready){alert('Open WebUI läuft noch nicht. Bitte zuerst „Open WebUI starten / einrichten“ ausführen.');return}window.open(w.url,'_blank','noopener')}
