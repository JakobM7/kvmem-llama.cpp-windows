...
try {
    ...
    Copy-Item (Join-Path $Root 'scripts/stop-dashboard.ps1') (Join-Path $stage 'stop-dashboard.ps1')
    Copy-Item (Join-Path $Root 'stop.bat') (Join-Path $stage 'stop.bat')
    ...
    Copy-Item (Join-Path $Root 'scripts/stop-iq3.ps1') (Join-Path $stage 'scripts/stop-iq3.ps1')
    Copy-Item (Join-Path $Root 'scripts/stop-iq4.ps1') (Join-Path $stage 'scripts/stop-iq4.ps1')
    Copy-Item (Join-Path $Root 'scripts/stop-open-webui.ps1') (Join-Path $stage 'scripts/stop-open-webui.ps1')
    Copy-Item (Join-Path $Root 'scripts/stop-dashboard.ps1') (Join-Path $stage 'scripts/stop-dashboard.ps1')
